...
@property (nonatomic, strong) NSMutableDictionary *gestureKeysHash;
...
- (void)addTapGestureRecognizer:(void(^)(UITapGestureRecognizer *recognizer, NSString *gestureId))tapCallback tapGestureId:(NSString *)tapGestureId numberOfTapsRequired:(NSInteger)numberOfTapsRequired numberOfTouchesRequired:(NSInteger)numberOfTouchesRequired;
